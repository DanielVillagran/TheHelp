                                ...
                                <div class="d-form-agregar-dep">
                                    ...
                                    <?php if (isset($id) && $id > 0) { ?>
                                        <ul class="nav nav-tabs" id="empresaTabs">
                                            <li class="active"><a class="color-principal" data-toggle="tab" href="#datos">Datos del colaborador</a></li>
                                            <li><a class="color-principal" data-toggle="tab" href="#otros">Historico de movimientos</a></li>
                                            ...
                                            <form id="Departamentos_info" enctype="multipart/form-data" onsubmit="save_Departamentos()" class="form-agregar-Intereses">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-4 col-md-4 pl-0">
                                                        ...
                                                        <input type="text" name="users[codigo]" class="form-control input-form" readonly />
                                                    </div>
                                                </div>

                                                <div class="form-group col-lg-4 col-md-4 pl-0">
                                                    <span class="floating-label-text">Apellido paterno *</span>
                                                    <input type="text" name="users[apellido_paterno]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-4 col-md-4 pl-0">
                                                    <span class="floating-label-text">Apellido materno *</span>
                                                    <input type="text" name="users[apellido_materno]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-4 col-md-4 pl-0">
                                                    <span class="floating-label-text">Nombre *</span>
                                                    <input type="text" name="users[nombre]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Razón Social *</span>
                                                    <select class="form-control input-form" name="users[razon_social]" disabled>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <select class="form-control input-form" id="empresa_select" name="users[cliente]" disabled>
                                                        <?php echo $clientes; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <select class="form-control input-form" name="users[sede]" id="sede_select" disabled></select>
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Puesto *</span>
                                                    <select class="form-control input-form" name="users[puesto]" id="puesto_select" disabled></select>
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Horario *</span>
                                                    <select class="form-control input-form" name="users[horario_id]" id="horario_select" disabled></select>
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">RFC *</span>
                                                    <input type="text" name="users[rfc]" id="rfc" maxlength="13" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">CURP *</span>
                                                    <input type="text" name="users[curp]" id="curp" maxlength="18" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">NSS *</span>
                                                    <input type="text" name="users[nss]" id="nss" maxlength="11" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Tipo de Nómina *</span>
                                                    <select class="form-control input-form" name="users[tipo_nomina]" disabled>
                                                        <?php echo $nominas; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <input type="date" name="users[fecha_alta]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Fecha de Nacimiento *</span>
                                                    <input type="date" name="users[fecha_nacimiento]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Lugar de Nacimiento *</span>
                                                    <input type="text" name="users[lugar_nacimiento]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Estado Civil *</span>
                                                    <select class="form-control input-form" name="users[estado_civil]" disabled>
                                                ...
                                                <div class="form-group col-lg-12 col-md-12 pl-0">
                                                    ...
                                                    <input type="text" name="users[direccion]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Estado *</span>
                                                    <select class="form-control input-form" name="users[estado]" disabled>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <input type="text" name="users[codigo_postal]" maxlength="5" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Banco *</span>
                                                    <select class="form-control input-form" name="users[banco]" disabled>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <input type="text" name="users[numero_cuenta]" maxlength="10" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Clave Interbancaria *</span>
                                                    <input type="text" name="users[clave_interbancaria]" maxlength="18" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Correo Electrónico *</span>
                                                    <input type="email" name="users[email]" class="form-control input-form" readonly />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Nombre de nomina en Nomipaq *</span>
                                                    <select class="form-control input-form" name="users[nomina_nomipaq]" disabled>
