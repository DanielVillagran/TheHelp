...
<style>
    .permisoEdicion {
        display: <?php echo ($this->tank_auth->user_has_privilege('Modificar encuestas') ? "block" :  "none"); ?>;
    }
</style>
                                ...
                                <div class="row row-buscar-agregar permisoEdicion">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="d-btn-agregar">
                                            <a id="btn_add_new" class="btn add-row btn-agregar"><i class="fa fa-plus"></i>Agregar Encuesta</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
