        ...
        <div style="padding-left: 0px; padding-right: 0px;" class="col-lg-12 col-md-12">
            <div class="d-bread">
                <ul class="list-page-breadcrumb">
                    ...
                    <li class="active-page">Agregar colonia</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="d-form-agregar-dep">
                                    <p class="title-sec">Agregar colonia</p>

                                    <form id="Departamentos_info" enctype="multipart/form-data" onsubmit="save_Departamentos()" class="form-agregar-colonias">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 pl-0">
                                            <div class="floating-label-group">
                                               <label class="label-static">Nombre de la colonia *</label>
                                                <input type="text" id="" name="users[nombre]" class="form-control input-form" required placeholder="Nombre"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 pl-0">

                                            <div class="floating-label-group">
                                                <label class="label-static">Denuncias *</label>
                                                <select name="users[can_denuncia]" class="form-control input-form" required>
