                    ...
                    <div class="widget-container margin-top-0">
                        <div class="widget-content">
                                ...
                                <div class="row row-buscar-agregar">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="d-btn-agregar">
                                            <a id="btn_add_new" class="btn add-row btn-agregar"><i class="fa fa-plus"></i>Agregar noticias</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive d-table-lg">
                                <table id="groups_grid" class="table table-lg table-noticias" data-filter="#filter" data-filter-text-only="true" data-page-size="10" data-limit-navigation="10">
                                    <thead>
                                        <tr>
