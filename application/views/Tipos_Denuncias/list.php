        ...
        <div style="padding-left: 0px; padding-right: 0px;" class="col-lg-12 col-md-12">
            <div class="d-bread">
                <ul class="list-page-breadcrumb">
                    ...
                    <li class="active-page">Tipos de denuncia</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="widget-container margin-top-0">
                        <div class="widget-content">
                            <div class="data-action-bar">
                                <p class="title-sec">Tipos de denuncia</p>
                                <div class="row row-buscar-agregar">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="d-btn-agregar">
                                            <a id="btn_add_new" class="btn add-row btn-agregar"><i class="fa fa-plus"></i>Agregar tipo de denuncia</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
