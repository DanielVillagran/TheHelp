...
<div class="login-form-container">
    <form id="newpass-form" method="post" data-parsley-validate="" class="j-forms" >
    <input type="hidden" name="user_id" id="user_id" value="<?= $id; ?>">
        ...
        <div class="login-form-content" style="text-align: center;">
            <!-- start login -->
            <h3>Restablezca su contrase&ntilde;a</h3><br>
            ...
            <div class="unit">
                <div class="input login-input">
                    ...
                    <input class="form-control login-frm-input"  type="password" id="newpass" name="newpass" placeholder="Contrase&ntilde;a" required>
                </div>
            </div>
            <div class="unit">
                <div class="input login-input">
                    ...
                    <input class="form-control login-frm-input"  type="password" id="confirmpass" name="confirmpass" placeholder="Confirmar contrase&ntilde;a" required>
                </div>
            </div>
            <!-- end login -->
