        ...
        <div style="padding-left: 0px; padding-right: 0px;" class="col-lg-12 col-md-12">
            <div class="d-bread">
                <ul class="list-page-breadcrumb">
                    ...
                    <li class="active-page">Agregar horarios</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="d-form-agregar-dep">
                                    <p class="title-sec">Agregar horario</p>
                                    ...
                                    <form id="Departamentos_info" enctype="multipart/form-data" onsubmit="save_Departamentos()" class="form-agregar-Intereses">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 pl-0">
                                            <div class="floating-label-group">
                                                <input type="text" name="users[horario]" class="form-control input-form" required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="users[lunes]" value="1"> Lunes
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="users[martes]" value="1"> Martes
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="users[miercoles]" value="1"> Miércoles
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="users[jueves]" value="1"> Jueves
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="users[viernes]" value="1"> Viernes
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="users[sabado]" value="1"> Sábado
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="users[domingo]" value="1"> Domingo
                                            </label>
                                        </div>
