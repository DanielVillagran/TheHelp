                                        ...
                                        <div class="tab-content" style="margin-top: 20px">
                                            ...
                                            <form id="Departamentos_info" enctype="multipart/form-data" onsubmit="save_Departamentos()" class="form-agregar-Intereses">
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <select class="form-control input-form" name="users[razon_social]" required>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <select class="form-control input-form" id="empresa_select" name="users[cliente]" required>
                                                        <?php echo $clientes; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <select class="form-control input-form" name="users[sede]" id="sede_select" required></select>
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Puesto *</span>
                                                    <select class="form-control input-form" name="users[puesto]" id="puesto_select" required></select>
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Horario *</span>
                                                    <select class="form-control input-form" name="users[horario_id]" id="horario_select" required></select>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <select class="form-control input-form" name="users[tipo_nomina]" required>
                                                        <?php echo $nominas; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <input type="text" name="users[sd]" id="sd_input" readonly class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Sueldo *</span>
                                                    <input type="text" name="users[sueldo]" id="sueldo_input" readonly class="form-control input-form" required />
                                                </div>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <input type="date" name="users[fecha_nacimiento]" class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Lugar de Nacimiento *</span>
                                                    <input type="text" name="users[lugar_nacimiento]" class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Estado Civil *</span>
                                                    <select class="form-control input-form" name="users[estado_civil]" required>
                                                ...
                                                <div class="form-group col-lg-12 col-md-12 pl-0">
                                                    ...
                                                    <input type="text" name="users[direccion]" class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Estado *</span>
                                                    <select class="form-control input-form" name="users[estado]" required>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <input type="text" name="users[codigo_postal]" maxlength="5" class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Banco *</span>
                                                    <select class="form-control input-form" name="users[banco]" required>
                                                ...
                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    ...
                                                    <input type="text" name="users[numero_cuenta]" maxlength="10" class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Clave Interbancaria *</span>
                                                    <input type="text" name="users[clave_interbancaria]" maxlength="18" class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Correo Electrónico *</span>
                                                    <input type="email" name="users[email]" class="form-control input-form" required />
                                                </div>

                                                <div class="form-group col-lg-6 col-md-6 pl-0">
                                                    <span class="floating-label-text">Nombre de nomina en Nomipaq *</span>
                                                    <select class="form-control input-form" name="users[nomina_nomipaq]" required>
