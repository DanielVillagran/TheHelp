...
class Departamentos_Servicios_Citas_Agenda_Model extends ANT_Model
{

    protected static $table = 'departamentos_servicios_citas_agenda';
    ...
    public static function get_grid_info($where = null, $list = null, $agent = null)
    {
        $lista = '';
        $result = array();
        $options = array(
