...
class Tipos_Denuncias_Model extends ANT_Model {

	protected static $table = 'tipos_denuncias';
	...
	static function get_grid_info($where = NULL, $list = NULL, $agent = NULL) {
		...
		$result = Tipos_Denuncias_Model::Load($options);
		return $result;
	}
	static function get_select($where = NULL, $list = NULL, $agent = NULL) {
		$lista = '<option value="all">-- Todas las Tipos_Denuncias --</option>';
		$lista="";
		$result = array();
		$options = array(
			'select' => '*',
