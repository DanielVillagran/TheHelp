...
$("#btn_add_new").click(function() {
    window.location.href = '/Tipos_Denuncias/add';
});

function grid_load_data() {
    $.ajax({
        url: "/Tipos_Denuncias/get_Tipos_Denuncias",
        type: 'POST',
        data: {
...
$('#groups_grid').footable().on('click', '.row-edit', function(e) {
    ...
    window.location.href = '/Tipos_Denuncias/edit/' + idemp;
});